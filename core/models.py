...
#     20 last games          https://americas.api.riotgames.com/lol/match/v5/matches/by-puuid/kzsMmNAH4GCNjPnprQ4pK5uuqHtVeiLXwPMtNxg_vgRvPeCmClTGZNBfDve1ginEnR_TccRqDE1o1Q/ids?start=0&count=20&api_key=RGAPI-a2da118a-064e-48e8-a9e7-f4cae50d6cf2
        # count = game number             # nota: LA2_1464005525 one ranked
        # type
            # ranked, normal, tourney, tutorial
#    game detail             https://americas.api.riotgames.com/lol/match/v5/matches/LA2_1464005525?api_key=RGAPI-a2da118a-064e-48e8-a9e7-f4cae50d6cf2
